...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT libdeflate::libdeflate_shared #############
        ...
        set_property(TARGET libdeflate::libdeflate_shared APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${libdeflate_libdeflate_libdeflate_shared_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET libdeflate::libdeflate_shared APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${libdeflate_libdeflate_libdeflate_shared_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET libdeflate::libdeflate_shared APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${libdeflate_libdeflate_libdeflate_shared_LIB_DIRS_RELEASE}>)
        set_property(TARGET libdeflate::libdeflate_shared APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${libdeflate_libdeflate_libdeflate_shared_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET libdeflate::libdeflate_shared APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${libdeflate_libdeflate_libdeflate_shared_COMPILE_OPTIONS_RELEASE}>)


    ########## AGGREGATED GLOBAL TARGET WITH THE COMPONENTS #####################
    set_property(TARGET libdeflate::libdeflate_shared APPEND PROPERTY INTERFACE_LINK_LIBRARIES libdeflate::libdeflate_shared)

########## For the modules (FindXXX)
set(libdeflate_LIBRARIES_RELEASE libdeflate::libdeflate_shared)
