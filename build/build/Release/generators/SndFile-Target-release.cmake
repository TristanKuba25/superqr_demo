...
########## GLOBAL TARGET PROPERTIES Release ########################################
    set_property(TARGET SndFile::sndfile
                 APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                 $<$<CONFIG:Release>:${libsndfile_OBJECTS_RELEASE}>
                 $<$<CONFIG:Release>:${libsndfile_LIBRARIES_TARGETS}>
                 )

    if("${libsndfile_LIBS_RELEASE}" STREQUAL "")
    ...
    set_property(TARGET SndFile::sndfile
                 ...
                 $<$<CONFIG:Release>:${libsndfile_LINKER_FLAGS_RELEASE}>)
    set_property(TARGET SndFile::sndfile
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${libsndfile_INCLUDE_DIRS_RELEASE}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET SndFile::sndfile
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${libsndfile_LIB_DIRS_RELEASE}>)
    set_property(TARGET SndFile::sndfile
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${libsndfile_COMPILE_DEFINITIONS_RELEASE}>)
    set_property(TARGET SndFile::sndfile
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${libsndfile_COMPILE_OPTIONS_RELEASE}>)
